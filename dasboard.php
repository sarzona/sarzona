...
<?php include('navbar_dasboard.php'); ?>
			...
			<div class="row">
				...
				<div class="span3">
					    <ul class="nav nav-tabs nav-stacked">
							<li class="active">
							<a href="#"><i class="icon-pencil icon-large"></i>&nbsp;Active Account</a>
							</li>
				...
				<div class="alert alert-info">Office Hours</div>
						...
						<p>Morente Avenue Bagumbayan </p>
						<p>Roxas, Oriental Mindoro Philippines</p>
				...
				<div class="testimonial_div">
					<p>
					I was delighted with the treatment. Despite me being a somewhat difficult patient Dr. Ruel S. Taytay was really gentle, patient and understanding.
    ...
    <button type="submit" name="sub" class="btn btn-info"><i class="icon-check icon-large"></i>&nbsp;Submit</button>
				...
				<div class="alert alert-info">Dr. Ruel S. Taytay</div>	
					<img  class="img img-polaroid" src="images/ta.jpg">
				</div>
